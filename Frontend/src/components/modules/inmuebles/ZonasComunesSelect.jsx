...
const ZonasComunesSelect = ({ selectedOptions = [], setSelectedOptions, onSelectionChange }) => {
    ...
    useEffect(() => {
        const fetchZonas = async () => {
            try {
                const data = await ZonasService.getZonas("comunes");
                if(data){
                    setZonas(data);
                }else{
                    setZonas([]);
...
export default ZonasComunesSelect;
